...
<img align="left"  src="image6.png" width="200" > Bringing the 1 over to the left side makes it equal to or greater than zero. For the samples in the gutter it's going to be exactly zero.
